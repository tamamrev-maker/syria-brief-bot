...
SYRIA_CONTEXT = """
## السياق السوري الراهن (2025-2026) — اقرأ هذا أولاً قبل أي تحليل:

- في 8 ديسمبر 2024 سقط نظام بشار الأسد بعد هجوم سريع قادته هيئة تحرير الشام وفصائل المعارضة المسلحة
- أحمد الشرع (أبو محمد الجولاني) يقود المرحلة الانتقالية كرئيس للحكومة السورية الجديدة
- سوريا الآن في مرحلة إعادة بناء: حكومة جديدة، مؤسسات منهارة، اقتصاد مدمر، ملايين النازحين
- التوترات القائمة: الوجود العسكري الإسرائيلي في الجنوب، وجود قوات أمريكية في الشمال الشرقي، قوات سوريا الديمقراطية (قسد) في الشمال
- المشهد الطائفي حساس: مسيحيون، علويون، دروز، أكراد، إيزيديون — كلهم في مرحلة إعادة تموضع
- العقوبات الغربية بدأت ترفع تدريجياً، والدول العربية تعيد فتح سفاراتها
- الأولويات الكبرى: الدستور، الانتخابات، الملف الاقتصادي، عودة اللاجئين، المصالحة الوطنية

## قواعد التحليل:
- لا تنطلق من أطر ما قبل 2024 — سوريا تغيرت جذرياً
- كن محايداً: لا تمجّد أي طرف ولا تشيطنه
- ركّز على التأثير الإنساني والسياسي الفعلي
- اربط الخبر بمسار التحول السوري الجاري
"""
...
def analyze_news(text):
    ...
    prompt = (
        "أنت مدير تحريري صحفي محترف ومحايد متخصص في الشأن السوري.\n\n"
        + SYRIA_CONTEXT +
        "\n---\n"
        "اليوم: " + today_str + "\n\n"
        "حلل الخبر التالي بناءً على السياق الحالي لسوريا 2025-2026، وليس على أساس أطر قديمة.\n\n"
        "أعطني:\n"
        "📌 الملخص التحريري — ما الذي حدث فعلاً؟\n"
        "🎯 الزاوية الأهم — ما الجانب الأبرز للتغطية؟\n"
        "🔍 السياق الراهن — كيف يرتبط بمسار سوريا اليوم؟\n"
        "⚖️ التوازن — ما المواقف والأطراف المختلفة؟\n"
        "❓ أسئلة للمتابعة — ما الذي يجب البحث عنه؟\n\n"
        "💡 أفكار المحتوى:\n"
        "🎠 كاروسيل — \n"
        "🎬 فيديو قصير — \n"
        "🧵 ثريد — \n\n"
    ...
    return call_api(prompt, max_tokens=2000, use_search=False)
